    ...
    <section class="py-10 sm:py-16 lg:py-24">
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            ...
            <div class="max-w-3xl mx-auto mt-8 space-y-4 md:mt-16">
                <div
                    style="background-color: #2b3e50" class="transition-all duration-200 bg-white border border-gray-200 shadow-lg cursor-pointer hover:bg-gray-50">
                    <button type="button" id="question1" data-state="closed" class="flex items-center justify-between w-full px-4 py-5 sm:p-6">
                        <span style="color: #FBEEC1;" class="flex text-lg font-semibold">How can I get started?</span>
                    ...
                    <div id="answer1" style="display:none" class="px-4 pb-5 sm:px-6 sm:pb-6">
                        <p style="color: #FBEEC1;">Getting started is easy! Sign up for an account, and you'll have access to our platform's
                ...
                <div
                    ...
                    <button type="button" id="question2" data-state="closed" class="flex items-center justify-between w-full px-4 py-5 sm:p-6">
                        <span style="color: #FBEEC1;" class="flex text-lg font-semibold">What is the pricing structure?</span>
                    ...
                    <div id="answer2" style="display:none" class="px-4 pb-5 sm:px-6 sm:pb-6">
                        <p style="color: #FBEEC1;">Our pricing structure is flexible. We offer both free and paid plans. You can choose the one
                ...
                <div
                    ...
                    <button type="button" id="question3" data-state="closed" class="flex items-center justify-between w-full px-4 py-5 sm:p-6">
                        <span style="color: #FBEEC1;" class="flex text-lg font-semibold">What kind of support do you provide?</span>
                    ...
                    <div id="answer3" style="display:none" class="px-4 pb-5 sm:px-6 sm:pb-6">
                        <p style="color: #FBEEC1;">We offer comprehensive customer support. You can reach out to our support team through
                            various channels, including email, chat, and a knowledge base.</p>
                    </div>
                </div>
                <div
                    style="background-color: #2b3e50" class="transition-all duration-200 bg-white border border-gray-200 shadow-lg cursor-pointer hover:bg-gray-50">
                    <button type="button" id="question4" data-state="closed" class="flex items-center justify-between w-full px-4 py-5 sm:p-6">
                        <span style="color: #FBEEC1;" class="flex text-lg font-semibold">Can I cancel my subscription anytime?</span>
                    ...
                    <div id="answer4" style="display:none" class="px-4 pb-5 sm:px-6 sm:pb-6">
                        <p style="color: #FBEEC1;">Yes, you can cancel your subscription at any time without any hidden fees. We believe in
            ...
            <p class="text-center text-gray-600 textbase mt-9" style="color: #FBEEC1;">
                ...
                <span class="cursor-pointer font-medium text-tertiary transition-all duration-200 hover:text-tertiary focus:text-tertiary hover-underline" style="color: #FBEEC1;">Contact
                    our support
                </span>
            </p>
        </div>
