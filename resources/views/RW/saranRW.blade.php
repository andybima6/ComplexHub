...
@section('content')
    ...
    <main class="mx-auto p-36 " style="min-height: 100vh; background-color: #FBEEC1;">
        ...
        <div class="opsi flex flex-col md:flex-row md:justify-between mt-20">
            <div class="md:w-2/5 h-96 rounded-md md:relative md:mr-16 mt-4 md:mt-0"
            ...
            <p class="w-911 h-62 relative md:left-20 top-16 text-center md:text-left"
                ...
                Total Pengaduan :
            <div id="total-saran" class="w-911 h-62 relative md:left-96 top-12 ml-12 text-center md:text-left"
            ...
            <div class="md:w-2/5 h-96 rounded-md md:ml-4 "
                style="background-color: #659DBD; filter: drop-shadow(12px 13px 4px rgba(2, 109, 124, 0.25));">
                ...
                <tbody id="saran-table">>
                    @foreach ($suggestions as $index => $suggestion)
                        <tr data-id="{{ $suggestion->rt_id }}">
                            ...
                            <td class="border px-4 py-2 text-center" style="color: black">RT {{ $suggestion->rt_id }}</td>
