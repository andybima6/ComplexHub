...
<div class="rounded-md relative p-16 top-24 left-16 bg-white mr-28">
    <p class="mb-10"
        style="font-size: 24px; font-family: 'Poppins', sans-serif; font-weight: 600; color: #2A424F;">Daftar Destinasi Wisata yang akan di kunjungi :</p>
    <table class="md:table-fixed w-full">
        <thead>
            <tr>
                <th class="border px-4 py-2 text-center w-1/7">No</th>
                <th class="border px-4 py-2 text-center w-1/7">Nama Tempat Wisata</th>
        ...
        <tbody>
            <tr>
                ...
                <td class="border px-4 py-2 text-center">Kayutangan Heritage</td>
            ...
            <tr>
                ...
                <td class="border px-4 py-2 text-center">Bromo Tengger Semeru</td>
                <td class="border px-4 py-2 text-center grid grid-cols-3 gap-0">
                    <button class="" style="width:45px;height:34px;border-radius:10px;background-color:#2F80ED">
                        <svg style="margin-left: 10px;margin-top:2px" width="25" height="24" viewBox="0 0 25 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
            ...
            <tr>
                ...
                <td class="border px-4 py-2 text-center">Malang SkyLand</td>
                <td class="border px-4 py-2 text-center grid grid-cols-3 gap-0">
                    <button class="" style="width:45px;height:34px;border-radius:10px;background-color:#2F80ED">
                        <svg style="margin-left: 10px;margin-top:2px" width="25" height="24" viewBox="0 0 25 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
