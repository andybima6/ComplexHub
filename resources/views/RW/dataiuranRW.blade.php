...
<main class="mx-auto p-36 contain-responsive" style="min-height: 100vh; background-color: #FBEEC1;">
    ...
    <div class="rounded-md relative p-16 top-32 left-16" style="background-color: white">
        <p class="mb-10" style="font-size: 24px; font-family: 'Poppins', sans-serif; font-weight: 600; color: black;">Data Iuran RT:</p>
        <hr class="mb-6">

        <!-- Search form -->
        <form method="GET" action="{{ route('cari') }}">
            <div class="mb-4">
                <label for="rt_id_search" class="block text-sm font-medium text-gray-700">Cari RT ID:</label>
                <input type="text" id="rt_id_search" name="rt_id_search" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Masukkan RT ID">
            </div>
