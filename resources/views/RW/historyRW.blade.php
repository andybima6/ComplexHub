...
<main class="mx-auto p-36 contain-responsive" style="min-height: 100vh; background-color: #FBEEC1;">
    ...
    <div class="rounded-md relative p-16 top-32 left-16 shadow-lg" style="background-color: white">
        <p class="mb-10" style="font-size: 24px; font-family: 'Poppins', sans-serif; font-weight: 600; color: black;">
            Cek Data:</p>
        <hr class="mb-6">
        {{-- <p class="mb-6"
            style="font-size: 18px; font-family: 'Poppins', sans-serif; font-weight: 500; color: black;">{{
        ...
        <table class="md:table-fixed w-full border-collapse rounded-lg overflow-hidden">
            <thead>
                <tr class="bg-gray-200">
                    ...
                    <th class="border px-4 py-2 text-center w-1/6" style="color: black">Keterangan</th>
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-100">
                    <td class="border px-4 py-2 text-center" style="color: black">{{ $index->id }}</td>
                    <td class="border px-4 py-2 text-center" style="color: black">{{ $index->nama }}</td>
                    <td class="border px-4 py-2 text-center" style="color: black">{{ $index->keterang }}</td>
                    <td class="border px-4 py-2 text-center" style="color: black">
                        <div class="flex justify-center">
                            <img src="{{ asset('storage/' . $index->bukti) }}" alt="">
                        </div>
                    </td>
                    {{-- <td class="border px-4 py-2 text-center" data-number="{{ $index + 1 }}">{{ $index + 1 }} --}}
                    <td class="border px-4 py-2 text-center" style="color: black">
                        <button class="btn-detail bg-blue-500 hover:bg-blue-600 text-white font-bold py-1 px-2 rounded"
                        ...
                        <button
                            class="btn-acc bg-green-500 hover:bg-green-600 text-white font-bold py-1 px-2 rounded ml-2"
                            style="border-radius: 10px">
                            <svg width="25" height="24" viewBox="0 0 25 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
