...
<main class="mx-auto p-8 sm:p-16 md:p-36 contain-responsive" style="min-height: 100vh; background-color: #FBEEC1;">
    <div class="rounded-md relative p-4 sm:p-8 md:p-16 top-8 sm:top-16 md:top-32 left-2 sm:left-8 md:left-16 bg-white">
        ...
        <form method="GET" action="{{ route('historyRW') }}" class="flex items-end mb-6 space-x-4">
            <div class="mb-4">
                <label for="search" class="block text-sm font-medium text-gray-700 mb-1">
                    <span>Search</span>
                </label>
                <input type="text" id="search" name="search" value="{{ request('historyRW.search') }}" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
            ...
            <table class="table-auto w-full border-collapse border border-gray-300">
                ...
                <tbody id="iuran-table">
                    ...
                    <tr class="text-center">
                        ...
                        <td class="border px-4 py-2">Rp.{{ $ir->total }}</td>
