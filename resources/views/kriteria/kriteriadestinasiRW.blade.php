    ...
    <main class="mx-auto p-36 contain-responsive" style="min-height: 100vh; background-color: #FBEEC1;">
        ...
        <div class="rounded-md relative p-16 top-32 left-16" style="background-color: white;">
            <div class="card-header mb-4 flex justify-between items-center">
                <h2 class="text-2xl font-semibold">List Data Kriteria</h2>
                <a href="{{ route('kriteria.create', ['nama' => 'Fasilitas']) }}" class="btn btn-primary">Tambah Kriteria</a>
            </div>
            <div class="card-body">
                ...
                <table class="table-auto w-full border-collapse border border-gray-300">
                    <thead>
                        <tr>
                            ...
                            <th class="border px-4 py-2 text-center" style="color: black">Jenis</th>
                    ...
                    <tbody>
                        @foreach ($kriteria as $item)
                            <tr>
                                ...
                                <td class="border px-4 py-2 text-center" style="color: black">{{ $item->nama }}</td>
                                <td class="border px-4 py-2 text-center" style="color: black">{{ $item->jenis }}</td>
