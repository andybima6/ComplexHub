      ...
      <table class="md:table-fixed w-full">
          <thead>
              <tr>
                  ...
                  <th class="border px-4 py-2 text-center w-1/6" style="color: black">Validasi</th>
          ...
          <tbody>
              <tr>
                  ...
                  <td class="border px-4 py-2 text-center" style="color: black"><button type="button" class="btn btn-primary">Tervalidasi</button></td>
                  ...
                  <td class="border px-4 py-2 text-center" style="color: black">
                      <button class="btn-detail bg-blue-500 hover:bg-blue-600 text-white font-bold py-1 px-2 rounded" style="border-radius: 10px"><a href = "{{ asset('img/dana.png') }}">
