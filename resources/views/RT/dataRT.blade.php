            ...
            <table class="md:table-fixed w-full">
                <thead>
                    <tr>
                        ...
                        <th class="border px-4 py-2 text-center w-1/6" style="color: black">Nama Lengkap</th>
                        <th class="border px-4 py-2 text-center w-1/6" style="color: black">Ketua RT-</th>
                        ...
                        <th class="border px-4 py-2 text-center w-1/6" style="color: black">Status dari R   T</th>
