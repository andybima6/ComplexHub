...
@section('content')
                    ...
                    <div class="kotak-content" style="background-color: #50E3C2;">
                        ...
                        <div class="text-container">
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                ...
                                viewBox="0 0 85.988 85.987" style="enable-background:new 0 0 85.988 85.987;"
                                xml:space="preserve">
                                <g>
                    ...
                    <div class="kotak-content" style="background-color: #F5A623;">
                        ...
                        <div class="text-container">
                            <svg width="40px" height="40px" viewBox="0 0 24 24" version="1.1"
                                ...
                                <g id="Iconly/Light-Outline/Activity" stroke="none" stroke-width="1" fill="none"
                                    fill-rule="evenodd">
                            ...
                            <h5>Jumlah Kegiatan : {{ count($activities) }}</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="kotak" style="display: flex; flex-wrap: wrap; justify-content: center;">
                <div class="kotak-item">
                    <div class="kotak-content" style="background-color: #3F51B5;">
                        ...
                        <div class="text-container">
                            <svg version="1.1" id="_x31_-outline-expand" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64"
                                style="enable-background:new 0 0 64 64; width: 40px; height: 40px;" xml:space="preserve">
                    ...
                    <div class="kotak-content" style="background-color: #2196F3;">
                        ...
                        <div class="text-container">
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                ...
                                style="enable-background:new 0 0 512.013 512.014;"xml:space="preserve">
                                <g fill="white">
                                    <path
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            fetch('/get-chart-data-rw') // Endpoint to get the chart data
                .then(response => response.json())
                .then(data => {
                    // Prepare seriesData and labels
                    const labels = Object.keys(data).map(rt_id => `RT ${String(rt_id).padStart(2, '0')}`);
