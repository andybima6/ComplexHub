           ...
           <li class="pointer mb3">
               <a class = "w-100 flex"
                ...
                "onclick="toggleDropdown('dropdown-datawarga')">
                   ...
                   <span style="margin-left: 10px;">Pendataan</span></a>
               ...
               <ul id="dropdown-kegiatan" class="list-reset dropdown-content ml3">
                   ...
                   <li class = "w-100  flex h-fit items-center">
                       ...
                       <a href="{{ url('destinasi/RW/destinasiwisataRW') }}"
                          style="color: #2A424F; text-decoration: none; font-family: 'Inter', sans-serif; font-weight: 400; font-size: 18px; margin-left: 7px;">Pemilihan Destinasi</a>
                   @endif
