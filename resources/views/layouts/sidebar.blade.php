   ...
   <div id="sidenav" class="fixed z-[9999999999] top-0 left-0 p3">
    ...
    <ul class="list-reset ">
        ...
        <li class="pointer mb3">
            <a class = "w-100 flex" href="{{ auth()->user()->role_id == 1 ? url('saran/RT/saranRT') : (auth()->user()->role_id == 2 ? url('saran/RW/saranRW') : url('saran/PD/saranPD')) }}"
                style="color: #2A424F; text-decoration: none; font-family: 'Inter', sans-serif; font-weight: 600; font-size: 24px;">
        ...
        <li class="pointer mb3">
            ...
            <ul id="dropdown-umkm" class="list-reset dropdown-content ml3">
                <li class = "w-100  flex h-fit items-center">
                    ...
                    <a  href="{{ auth()->user()->role_id == 1 ? url('/RT/izinUsahaRT') : (auth()->user()->role_id == 2 ? url('/RW/izinUsahaRW') : url('/PD/izinUsahaPD')) }}"
                ...
                <li class = "w-100  flex h-fit items-center">
                    ...
                    <a  href="{{ auth()->user()->role_id == 1 ? url('/RT/dataUsahaRT') : (auth()->user()->role_id == 2 ? url('/RW/dataUsahaRW') : url('/PD/dataUsahaPD')) }}"
        ...
        <li class="pointer mb3">
            ...
            <ul id="dropdown-kegiatan" class="list-reset dropdown-content ml3">
                <li class = "w-100  flex h-fit items-center">
                    ...
                    <a href="{{ auth()->user()->role_id == 1 ? url('usulan/RT/usulanKegiatanRT') : (auth()->user()->role_id == 2 ? url('usulan/RW/usulanKegiatanRW') : url('usulan/PD/usulanKegiatanPD')) }}"
