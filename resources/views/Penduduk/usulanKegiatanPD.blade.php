    ...
    <main class="mx-auto p-5 sm:p-10 md:p-2 contain-responsive" style="min-height: 50vh; background-color: #FBEEC1;">
        <div class="flex flex-col md:flex-row md:justify-between mt-20 py-24 relative z-10">
            <div class="mt-4 md:mt-0 relative mx-auto md:ml-52"
                ...
                <p class="relative top-6 text-center md:text-lef-4"
                    style="font-size: 45px; font-family: 'Poppins', sans-serif; font-weight: 600; color: #FFFEFE;">
                    RT :
                    <div class="values w-full h-62 relative top-2 text-center md:text-left-8"
    ...
    <div class="bgusulan relative inset-0 mx-auto mt-20 md:mt-56 w-11/12 md:w-2/3 z-0"
    style="position: absolute; top: 45%; left: 8%;">
    <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border-radius: 36px; opacity: 0.4;"></div>
    <img src="{{ asset('img/background.png') }}" class="justify-center items-center m-0 overflow-scroll rounded-2xl w-full h-auto"
        style="height: 950px; margin-bottom: 0px;">
    <span id="closeModal" class="close flex justify-center"
        ...
        Pengajuan kegiatan oleh penduduk di tingkat RW dan RT dapat mengoptimalkan partisipasi penduduk dalam pembangunan
        lingkungan serta mempercepat respons dan koordinasi dari pihak berwenang.
    </span>
</div>
        </main>
