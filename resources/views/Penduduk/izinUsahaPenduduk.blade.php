            ...
            <table class="md:table-fixed w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2 text-center" style="color: black">
                            <a href="{{ route('detailIzinUsaha', ['id' => $izin->id]) }}"><button class="btn-detail bg-blue-500 hover:bg-blue-600 text-white font-bold py-1 px-2 rounded" style="border-radius: 10px">
                            ...
                            <form action="{{ route('destroy', ['id' => $izin->id]) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn-tolak bg-red-500 hover:bg-red-600 text-white font-bold py-1 px-2 rounded ml-2" style="border-radius: 10px" oncanplay="return confirm('Yakin ingin menghapus izin ini?')">
                            ...
                            <button id="editIzin" class="btn-acc bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-1 px-2 rounded ml-2" style="border-radius: 10px" data-id="1">
