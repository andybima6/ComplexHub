...
@section('content')
    <main class="detail h-dvh w-3/4 mx-auto relative top-36">
        <div class="relative p-12 bg-white rounded-lg">
            ...
            <hr class="mb-4 mr-6">
            <div class="mb-4">
                <label for="" class="block text-lg font-bold text-gray-700">Tanggal Pengajuan:</label>
                <p class="font-medium">{{ $suggestion->tanggal }}</p>
            </div>
            <div class="mb-4">
                <label for="" class="block text-lg font-bold text-gray-700">Bidang Pengajuan:</label>
            ...
            <div class="mb-4">
                <label for="" class="block text-lg font-bold text-gray-700">Isi Laporan Pengajuan :</label>
            ...
            <div class="absolute right-16 bottom-4 ">
                <button type="button"
                    ...
                    <a href="{{ route('saranPD') }}" style="text-decoration:none">Kembali</a>
                </button>
            </div>
        </div>
